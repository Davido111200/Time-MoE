...
MODEL=/scratch/s223540177/Time-MoE/chronos/ETTh1_finetuned
DATA=/scratch/s223540177/Time-Series-Library/data/all_datasets/ETT-small/ETTh1.csv
...
for LAM in $LAMS; do
  for K in {1..16}; do
    for WEIGHT in $WEIGHTS; do
      ...
      python /home/s223540177/Time-MoE/run_eval_steering_finetuned_chronos.py \
        -m "${MODEL}" \
        -d "${DATA}" \
        -p 96 \
        --data ETTh1 \
