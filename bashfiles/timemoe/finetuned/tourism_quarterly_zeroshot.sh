...
python -u run_eval.py \
  -d /scratch/s223540177/Time-Series-Library/data/all_datasets/tourism_quarterly_dataset.csv \
  -p 24 \
  -m /scratch/s223540177/Time-MoE/checkpoints/50M_tourism_quarterly \
