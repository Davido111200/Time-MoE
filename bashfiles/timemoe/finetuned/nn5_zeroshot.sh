...
python -u run_eval.py \
  -d /scratch/s223540177/Time-Series-Library/data/all_datasets/nn5_daily_dataset_without_missing_values.csv \
  -p 24 \
  -m /scratch/s223540177/Time-MoE/checkpoints/50M_nn5 \
  --data nn5 \
  --batch_size 1024 
