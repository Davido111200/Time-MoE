...
python -u run_eval.py \
  -d /scratch/s223540177/Time-Series-Library/data/all_datasets/rideshare_dataset_without_missing_values.csv \
  -p 24 \
  --data rideshare \
  --batch_size 512 \
  -m /scratch/s223540177/Time-MoE/checkpoints/50M_rideshare 
