...
python -u run_eval.py \
  -d /scratch/s223540177/Time-Series-Library/data/all_datasets/sunspot_dataset_without_missing_values.csv \
  -p 96 \
  -m /scratch/s223540177/Time-MoE/checkpoints/50M_sunspots \
  --data sunspots \
  --batch_size 1024 \