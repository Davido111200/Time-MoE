...
python -u run_eval.py \
  -d /scratch/s223540177/Time-Series-Library/data/all_datasets/vehicle_trips_dataset_without_missing_values.csv \
  -p 24 \
  -m /scratch/s223540177/Time-MoE/checkpoints/50M_vehicle \
  --data vehicle \
  --batch_size 1024 \