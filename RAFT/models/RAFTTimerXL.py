...
from layers.TimerXL import TimerXL
...
#         self.individual = individual
        ...
        for param in self.timerxl.model.parameters():
...
#                 configs.enc_in * configs.seq_len, configs.num_class)
    ...
    def encoder(self, x, index, mode):
        index = index.to(self.device).cpu()
        ...
        x_pred_from_x = self.timerxl.predict(x)
        x_pred_from_x = x_pred_from_x.reshape(B, C, self.pred_len).permute(0, 2, 1)  # B, P, C
        # print('x_pred_from_x: ', x_pred_from_x[0])
        # x_pred_from_x = self.linear_x(x_pred_from_x.permute(0, 2, 1)).permute(0, 2, 1) # B, P, C
        ...
        # print('x_pred_from_x: ', x_pred_from_x.shape)
